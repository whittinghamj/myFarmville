"""
Django settings for myFarmville project.
...
SECRET_KEY = '-gzn(@wrh5i4)t&qyejmngcnuov(2mj-6f!d*@!lbrr@oa2-ao'
...
WSGI_APPLICATION = 'myFarmville.wsgi.application'
